...
class CreateConfigEventJSON(typing.TypedDict):
    timestamp: int
    admin: str
...
class CreateConfigEvent:
    ...
    @classmethod
    def from_decoded(cls, obj: Container) -> "CreateConfigEvent":
        return cls(
    ...
    def to_json(self) -> CreateConfigEventJSON:
        return {
                "timestamp": self.timestamp,
    ...
    @classmethod
    def from_json(cls, obj: CreateConfigEventJSON) -> "CreateConfigEvent":
        return cls(
                timestamp=obj["timestamp"],
                admin=Pubkey.from_string(obj["admin"]),
                lpFeeBasisPoints=obj["lpFeeBasisPoints"],
