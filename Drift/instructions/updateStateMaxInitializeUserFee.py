...
class UpdateStateMaxInitializeUserFeeArgs(typing.TypedDict):
...
class UpdateStateMaxInitializeUserFeeAccounts(typing.TypedDict):
    admin:SolPubkey
    state:SolPubkey

def UpdateStateMaxInitializeUserFee(
