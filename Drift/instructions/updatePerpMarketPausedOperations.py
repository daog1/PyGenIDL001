...
class UpdatePerpMarketPausedOperationsArgs(typing.TypedDict):
...
class UpdatePerpMarketPausedOperationsAccounts(typing.TypedDict):
    admin:SolPubkey
    state:SolPubkey
    perpMarket:SolPubkey

def UpdatePerpMarketPausedOperations(
