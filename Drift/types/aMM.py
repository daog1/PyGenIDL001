...
class AMM:
    ...
    def from_decoded(cls, obj: Container) -> "AMM":
        return cls(
       oracle=Pubkey.from_string(obj["oracle"]),historicalOracleData=historicalOracleData.HistoricalOracleData.from_decoded(obj["historicalOracleData"]),baseAssetAmountPerLp=obj["baseAssetAmountPerLp"],quoteAssetAmountPerLp=obj["quoteAssetAmountPerLp"],feePool=poolBalance.PoolBalance.from_decoded(obj["feePool"]),baseAssetReserve=obj["baseAssetReserve"],quoteAssetReserve=obj["quoteAssetReserve"],concentrationCoef=obj["concentrationCoef"],minBaseAssetReserve=obj["minBaseAssetReserve"],maxBaseAssetReserve=obj["maxBaseAssetReserve"],sqrtK=obj["sqrtK"],pegMultiplier=obj["pegMultiplier"],terminalQuoteAssetReserve=obj["terminalQuoteAssetReserve"],baseAssetAmountLong=obj["baseAssetAmountLong"],baseAssetAmountShort=obj["baseAssetAmountShort"],baseAssetAmountWithAmm=obj["baseAssetAmountWithAmm"],baseAssetAmountWithUnsettledLp=obj["baseAssetAmountWithUnsettledLp"],maxOpenInterest=obj["maxOpenInterest"],quoteAssetAmount=obj["quoteAssetAmount"],quoteEntryAmountLong=obj["quoteEntryAmountLong"],quoteEntryAmountShort=obj["quoteEntryAmountShort"],quoteBreakEvenAmountLong=obj["quoteBreakEvenAmountLong"],quoteBreakEvenAmountShort=obj["quoteBreakEvenAmountShort"],userLpShares=obj["userLpShares"],lastFundingRate=obj["lastFundingRate"],lastFundingRateLong=obj["lastFundingRateLong"],lastFundingRateShort=obj["lastFundingRateShort"],last24hAvgFundingRate=obj["last24hAvgFundingRate"],totalFee=obj["totalFee"],totalMmFee=obj["totalMmFee"],totalExchangeFee=obj["totalExchangeFee"],totalFeeMinusDistributions=obj["totalFeeMinusDistributions"],totalFeeWithdrawn=obj["totalFeeWithdrawn"],totalLiquidationFee=obj["totalLiquidationFee"],cumulativeFundingRateLong=obj["cumulativeFundingRateLong"],cumulativeFundingRateShort=obj["cumulativeFundingRateShort"],totalSocialLoss=obj["totalSocialLoss"],askBaseAssetReserve=obj["askBaseAssetReserve"],askQuoteAssetReserve=obj["askQuoteAssetReserve"],bidBaseAssetReserve=obj["bidBaseAssetReserve"],bidQuoteAssetReserve=obj["bidQuoteAssetReserve"],lastOracleNormalisedPrice=obj["lastOracleNormalisedPrice"],lastOracleReservePriceSpreadPct=obj["lastOracleReservePriceSpreadPct"],lastBidPriceTwap=obj["lastBidPriceTwap"],lastAskPriceTwap=obj["lastAskPriceTwap"],lastMarkPriceTwap=obj["lastMarkPriceTwap"],lastMarkPriceTwap5min=obj["lastMarkPriceTwap5min"],lastUpdateSlot=obj["lastUpdateSlot"],lastOracleConfPct=obj["lastOracleConfPct"],netRevenueSinceLastFunding=obj["netRevenueSinceLastFunding"],lastFundingRateTs=obj["lastFundingRateTs"],fundingPeriod=obj["fundingPeriod"],orderStepSize=obj["orderStepSize"],orderTickSize=obj["orderTickSize"],minOrderSize=obj["minOrderSize"],maxPositionSize=obj["maxPositionSize"],volume24h=obj["volume24h"],longIntensityVolume=obj["longIntensityVolume"],shortIntensityVolume=obj["shortIntensityVolume"],lastTradeTs=obj["lastTradeTs"],markStd=obj["markStd"],oracleStd=obj["oracleStd"],lastMarkPriceTwapTs=obj["lastMarkPriceTwapTs"],baseSpread=obj["baseSpread"],maxSpread=obj["maxSpread"],longSpread=obj["longSpread"],shortSpread=obj["shortSpread"],longIntensityCount=obj["longIntensityCount"],shortIntensityCount=obj["shortIntensityCount"],maxFillReserveFraction=obj["maxFillReserveFraction"],maxSlippageRatio=obj["maxSlippageRatio"],curveUpdateIntensity=obj["curveUpdateIntensity"],ammJitIntensity=obj["ammJitIntensity"],oracleSource=oracleSource.from_decoded(obj["oracleSource"]),lastOracleValid=obj["lastOracleValid"],targetBaseAssetAmountPerLp=obj["targetBaseAssetAmountPerLp"],perLpBase=obj["perLpBase"],padding1=obj["padding1"],padding2=obj["padding2"],totalFeeEarnedPerLp=obj["totalFeeEarnedPerLp"],netUnsettledFundingPnl=obj["netUnsettledFundingPnl"],quoteAssetAmountWithUnsettledLp=obj["quoteAssetAmountWithUnsettledLp"],referencePriceOffset=obj["referencePriceOffset"],padding=obj["padding"]
        )
