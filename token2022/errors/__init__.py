...
from . import associatedToken


def from_code(code: int) -> typing.Union[associatedToken.CustomError, None]:
    return associatedToken.from_code(code)
...
def from_tx_error(
    error: RPCException,
) -> typing.Union[associatedToken.CustomError, None]:
