...
"ConfidentialTransferMint" / SizePrefix(borsh.U16,borsh.CStruct("authority" /ZeroableOption(BorshPubkey,None,"publicKey"),"autoApproveNewAccounts" /borsh.Bool,"auditorElgamalPubkey" /ZeroableOption(BorshPubkey,None,"publicKey"))),
...
"ConfidentialTransferFee" / SizePrefix(borsh.U16,borsh.CStruct("authority" /ZeroableOption(BorshPubkey,None,"publicKey"),"elgamalPubkey" /BorshPubkey,"harvestToMintEnabled" /borsh.Bool,"withheldAmount" /encryptedBalance.EncryptedBalance)),
"ConfidentialTransferFeeAmount" / SizePrefix(borsh.U16,borsh.CStruct("withheldAmount" /encryptedBalance.EncryptedBalance)),
"MetadataPointer" / SizePrefix(borsh.U16,borsh.CStruct("authority" /ZeroableOption(BorshPubkey,None,"publicKey"),"metadataAddress" /ZeroableOption(BorshPubkey,None,"publicKey"))),
"TokenMetadata" / SizePrefix(borsh.U16,borsh.CStruct("updateAuthority" /ZeroableOption(BorshPubkey,None,"publicKey"),"mint" /BorshPubkey,"name" /borsh.String,"symbol" /borsh.String,"uri" /borsh.String,"additionalMetadata" /borsh.HashMap(borsh.String,borsh.String))),
"GroupPointer" / SizePrefix(borsh.U16,borsh.CStruct("authority" /ZeroableOption(BorshPubkey,None,"publicKey"),"groupAddress" /ZeroableOption(BorshPubkey,None,"publicKey"))),
"TokenGroup" / SizePrefix(borsh.U16,borsh.CStruct("updateAuthority" /ZeroableOption(BorshPubkey,None,"publicKey"),"mint" /BorshPubkey,"size" /borsh.U64,"maxSize" /borsh.U64)),
"GroupMemberPointer" / SizePrefix(borsh.U16,borsh.CStruct("authority" /ZeroableOption(BorshPubkey,None,"publicKey"),"memberAddress" /ZeroableOption(BorshPubkey,None,"publicKey"))),
...
"PausableConfig" / SizePrefix(borsh.U16,borsh.CStruct("authority" /ZeroableOption(BorshPubkey,None,"publicKey"),"paused" /borsh.Bool)),
