...
class SetTransferFeeArgs(typing.TypedDict):
...
class SetTransferFeeAccounts(typing.TypedDict):
    mint:SolPubkey
...
def SetTransferFee(
    ...
    AccountMeta(pubkey=accounts["transferFeeConfigAuthority"], is_signer=True, is_writable=False),
    ]
