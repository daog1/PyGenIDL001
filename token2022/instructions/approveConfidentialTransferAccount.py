...
class ApproveConfidentialTransferAccountArgs(typing.TypedDict):
...
class ApproveConfidentialTransferAccountAccounts(typing.TypedDict):
    token:SolPubkey
    mint:SolPubkey
    authority:SolPubkey

def ApproveConfidentialTransferAccount(
    args: ApproveConfidentialTransferAccountArgs,
