...
class InitializeInterestBearingMintAccounts(typing.TypedDict):
    mint:SolPubkey

def InitializeInterestBearingMint(
    args: InitializeInterestBearingMintArgs,
    ...
    encoded_args = layout.build({
        ...
        "rateAuthority":args["rateAuthority"],
        "rate":args["rate"],
       })
