...
class HarvestWithheldTokensToMintArgs(typing.TypedDict):
...
class HarvestWithheldTokensToMintAccounts(typing.TypedDict):
    mint:SolPubkey

def HarvestWithheldTokensToMint(
    args: HarvestWithheldTokensToMintArgs,
