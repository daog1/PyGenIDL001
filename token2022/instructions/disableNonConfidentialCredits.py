...
class DisableNonConfidentialCreditsArgs(typing.TypedDict):
...
class DisableNonConfidentialCreditsAccounts(typing.TypedDict):
    token:SolPubkey
    authority:SolPubkey

def DisableNonConfidentialCredits(
    args: DisableNonConfidentialCreditsArgs,
