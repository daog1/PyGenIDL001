...
class EnableNonConfidentialCreditsArgs(typing.TypedDict):
...
class EnableNonConfidentialCreditsAccounts(typing.TypedDict):
    token:SolPubkey
    authority:SolPubkey

def EnableNonConfidentialCredits(
    args: EnableNonConfidentialCreditsArgs,
