...
class DisableHarvestToMintArgs(typing.TypedDict):
...
class DisableHarvestToMintAccounts(typing.TypedDict):
    mint:SolPubkey
    authority:SolPubkey

def DisableHarvestToMint(
    args: DisableHarvestToMintArgs,
