...
class UpdateTokenGroupMaxSizeArgs(typing.TypedDict):
    maxSize:int
...
class UpdateTokenGroupMaxSizeAccounts(typing.TypedDict):
    group:SolPubkey
    updateAuthority:SolPubkey

def UpdateTokenGroupMaxSize(
    args: UpdateTokenGroupMaxSizeArgs,
