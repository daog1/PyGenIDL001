...
class WithdrawWithheldTokensFromMintForConfidentialTransferFeeArgs(typing.TypedDict):
...
class WithdrawWithheldTokensFromMintForConfidentialTransferFeeAccounts(typing.TypedDict):
    mint:SolPubkey
...
def WithdrawWithheldTokensFromMintForConfidentialTransferFee(
    args: WithdrawWithheldTokensFromMintForConfidentialTransferFeeArgs,
